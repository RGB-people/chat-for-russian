...
local firebaseSuccess, firebaseModule = pcall(function()
    return loadstring(game:HttpGet(
        "https://raw.githubusercontent.com/ВАШ_НИК/chat-for-russian/main/client/firebase-wrapper.lua",
        true
    ))()
end)
...
local filterSuccess, filterModule = pcall(function()
    return loadstring(game:HttpGet(
        "https://raw.githubusercontent.com/ВАШ_НИК/chat-for-russian/main/client/profanity-filter.lua",
        true
    ))()
end)
...
local Config = {
    ...
    Firebase = {
        ...
        baseUrl = "https://chat-for-russian-xxxxx.firebaseio.com",
        -- Как получить:
        -- 1. Создай проект на firebase.google.com
        -- 2. Realtime Database → Скопируй URL
        -- 3. Пример: https://myproject-abc123.firebaseio.com
    },
